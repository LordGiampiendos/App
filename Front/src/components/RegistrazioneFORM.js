...
class RegistrazioneFORM extends Component {
    ...
    showPatente() {
        this.setState({isPatente:!this.state.isPatente});
    }
    showPagamento() {
        this.setState({isPagamento:!this.state.isPagamento});
    }
    ...
    registrazione(event){
        if(this.state.isPagamento && this.state.isPatente) {
        this.RegistrazioneService.registrazione4(this.state.nome, 
                                                this.state.genere,
                                                this.state.regione,
        ...
        else if(this.state.isPagamento && !this.state.isPatente) {
            this.RegistrazioneService.registrazione5(this.state.nome, 
                                                    this.state.genere,
                                                    this.state.regione,
                                                    this.state.provincia,
                                                    this.state.citta,
        ...
        this.RegistrazioneService.registrazione6(this.state.nome, 
                                                this.state.genere,
                                                this.state.regione,
                                                this.state.provincia,
                                                this.state.citta,
        ...
        this.RegistrazioneService.registrazione(this.state.nome, 
                                                this.state.genere,
                                                this.state.regione,
                                                this.state.provincia,
                                                this.state.citta,
    ...
    componentDidMount() {
        $(document).ready(function() {
            ...
            $('#idpatente').focusout(function(ev) {
                if ($(this).val() !== '') {
                    $('.form-p input').not('#idpatente').removeAttr('disabled');
                    $('.form-p input').not('#idpatente').attr('required', 'required');
                } else {
                    $('.form-p input').not('#idpatente').attr('disabled', 'disabled');
                    $('.form-p input').not('#idpatente').removeAttr('required');
                }
            }).keydown(function(ev) {
                if (ev.keyCode === 9) {
                    if ($(this).val() !== '') {
                        $('.form-p input').not('#idpatente').removeAttr('disabled');
                        $('.form-p input').not('#idpatenter').attr('required', 'required');
                    } else {
                        $('.form-p input').not('#idpatente').attr('disabled', 'disabled');
                        $('.form-p input').not('#idpatente').removeAttr('required');
                    }
            ...
            $('.pag').click(function() {
                $('div .form-m').show('slow').toggle();
            });

            $('.pat').click(function() {
                $('div .form-p').show('slow').toggle();
            });
    ...
    render() {
        ...
        return (
            ...
            <form className="container was-validated col-sm-8 mt-3" action="#" onSubmit={this.onSubmit.bind(this)}>
                    ...
                    <p className="lead text-uppercase mt-3">Metodo Pagamento(Opzionale)</p>
                    <div className="pag">
                        <input onClick={this.showPagamento.bind(this)} type="checkbox" className="pag" id="pag"/>
                    </div>
                    <div className="form-m">
                        ...
                        <div className="col-3">
                            ...
                            <br></br>
                            <input placeholder="nominativo_pagamento" onChange={this.changeText.bind(this, "nominativo_p")} name="nominative" id="nominative" type="text" className="form-control" maxLength="40" disabled/>
                            <div className="invalid-feedback">
                        ...
                        <div className="col-3">
                            ...
                            <br></br>
                            <input placeholder="data_scadenza" onChange={this.changeText.bind(this, "data_scadenza")} name="dates" id="dates" type="date" className="form-control" disabled/>
                            <div className="invalid-feedback">
                        ...
                        <div className="col-3">
                            ...
                            <br></br>
                            <input placeholder="codice_sicurezza" onChange={this.changeText.bind(this, "codice_sicurezza")} name="codex" id="codex" type="text" className="form-control" maxLength="3" disabled/>
                            <div className="invalid-feedback">
                    ...
                    <p className="lead text-uppercase mt-3">Patente(Opzionale)</p>
                    <div className="pat">
                        <input onClick={this.showPatente.bind(this)} type="checkbox" className="pat" id="pag"/>
                    </div>
                    <div className="form-p">
                        ...
                        <div className="col-3">
                            ...
                            <br></br>
                            <input placeholder="nazionalità_patente" onChange={this.changeText.bind(this, "nazionalità_patente")} name="nazpatente" id="nazpatente" type="text" className="form-control" maxLength="40" disabled/>
                            <div className="invalid-feedback">
                        ...
                        <div className="col-3">
                            ...
                            <br></br>
                            <input placeholder="data_rilascio" onChange={this.changeText.bind(this, "data_rilascio")} name="dataril" id="dataril" type="date" className="form-control" maxLength="40" disabled/>
                            <div className="invalid-feedback">
                                Data di rilascio
                            </div>
                        </div>
                        ...
                        <div className="col-3">
                            ...
                            <br></br>
                            <input placeholder="data_scadenza" onChange={this.changeText.bind(this, "data_scadenza2")} name="datasca" id="datasca" type="date" className="form-control" maxLength="40" disabled/>
                            <div className="invalid-feedback">
                        ...
                        <div className="col-3">
                            ...
                            <br></br>
                            <input placeholder="nominativo_patente" onChange={this.changeText.bind(this, "nominativo_pat")} name="nompatente" id="nompatente" type="text" className="form-control" maxLength="40" disabled/>
                            <div className="invalid-feedback">
