...
function SpecificheBND11() {
    const dispatch = useDispatch();
    let modello = 'Monopattino Grigio Scuro';
    let prezzoV = 1;
    return (
        <div id="div5">
            <br></br>
            <br></br>
            <center><img id="imgD" src={m2} alt="Immagine Monopattino Grigio Scuro"/></center>
            <br></br>
            <br></br>
...
export default SpecificheBND11;